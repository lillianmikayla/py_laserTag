...
def main():
    ...
    db = PlayerDatabase()  # No need to pass credentials!

    # Adding players
    db.add_player(500, 'BhodiLi')
    db.add_player(501, 'Alpha')

    # Retrieving player info
    print("Codename for ID 500:", db.get_codename_by_id(500))
    print("ID for codename 'Alpha':", db.get_id_by_codename('Alpha'))
